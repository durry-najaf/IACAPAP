...
<div class="form-group">
    ...
    <?php echo Core::make("helper/concrete/asset_library")->image('ccm-b-expectcards-icon-' . $identifier_getString, $view->field('icon'), t("Choose Image"), $icon_o); ?>
</div>
...
<?php $btn_ContainerID = 'btExpectcards-btn-container-' . $identifier_getString; ?>
  ...
  'class' => 'form-control ft-smart-link-type',
	...
	<div class="form-group">
		...
		<div class="form-group hidden" data-link-type="file">
            ...
            <small class="required"><?php echo t('Required'); ?></small>
            <?php echo Core::make("helper/concrete/asset_library")->file('ccm-b-expectcards-btn_File-' . $identifier_getString, $view->field('btn_File'), t("Choose File"), $btn_File_o); ?>	
		</div>
		...
		<div class="form-group hidden" data-link-type="image">
            ...
            <small class="required"><?php echo t('Required'); ?></small>
            <?php echo Core::make("helper/concrete/asset_library")->image('ccm-b-expectcards-btn_Image-' . $identifier_getString, $view->field('btn_Image'), t("Choose Image"), $btn_Image_o); ?>
		</div>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	Concrete.event.publish('btExpectcards.btn.open', {id: '<?php echo $btn_ContainerID; ?>'});
