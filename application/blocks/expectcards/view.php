...
<?php if ($icon) { ?>
    <div class="expect-section paddExpect"><div class="expect-card"><div class="icon"><img src="<?php echo $icon->getURL(); ?>" alt="<?php echo $icon->getTitle(); ?>"/></div><?php } ?>
...
if (trim($btn_URL) != "") { ?>
	...
	echo sprintf('<a %s>%s</a>', $btn_AttributesHtml, $btn_Title); ?></small></div></div><?php
} ?>
<style>
